...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="welcome.html" class="logo">
            ...
            <span class="logo-lg"><b>GAGAHI</b> 管理</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu" id="headAccountInfo">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${ctx}/dist/img/male.png" class="user-image" alt="User Image">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016-2019 <a href="#">Zoneyet Co</a>.</strong> All rights
        reserved.
    </footer>
...
<script src="${ctx}/plugins/layer/laydate.js"></script>

<!-- AdminLTE App -->
<script src="${ctx}/dist/js/app.min.js"></script>
<script src="${ctx}/dist/js/common.js?v=2020040102"></script>
