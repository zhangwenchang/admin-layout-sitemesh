    ...
    "bootstrap": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).addClass('pagination').append(
                ...
                '<input type="text" placeholder="跳转到" style="width: 70px; text-indent: 9px; height: 34px; border-radius: 0px 4px 4px 0px; border: solid 1px #ccc;border-left: none;" id="redirect" class="redirect">'+
                '</ul>'
                );
