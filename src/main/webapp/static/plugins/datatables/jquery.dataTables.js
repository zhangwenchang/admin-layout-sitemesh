...
(/** @lends <global> */function( $ ) {
	...
	function _fnDraw( oSettings )
	{
		...
		var _table = $(oSettings.nTable);
        var xuIndex = -1;
        var _start = oSettings._iDisplayStart;
        $.each(_table.find('th'), function(i) {
            if ($(this).html() == '序号') {
            	xuIndex = $(this).index();
            }
        });
        if (xuIndex >= 0) {
        	$.each(_table.find('tr'), function(index, el) {
	        	var tds = $(el).find('td');
	        	if (tds.length) {
	        		tds.eq(xuIndex).html(_start + index);
	        	}
	        });
        }        
	}
	...
	DataTable.defaults = {
		 ...
		 *    } );
		 */
		"aLengthMenu": [ 10, 20, 50, 100, 500, 1000, 5000, 10000, 30000, 50000 ],
